  ...
  return (
    <div className="App bg-background">
      ...
      >
        {/* Text Content */}
        <div
          className="absolute top-1/4 left-24 text-left  text-black"
          id="acceuil"
        >
          ...
          <Fade direction="down" cascade damping={0.2}>
            <h2 className="text-1xl font-calandea mb-4 sm:text-3xl md:text-2xl ">
              {t(
                "Des experts en coiffure, soins et massages à votre service, où que"
              )}{" "}
              <br />
              {t("vous soyez.")}
            </h2>
      ...
      <section id="nos-travaux" className="mx-12 mt-16">
        ...
        <h2
          ...
          } text-black tracking-wider mb-16 font-caladea`}
        >
          {t("NOTRE GALERIE")}
        </h2>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-background shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700">
                {t(
                  "Sublimez votre beauté avec nos soins visage et corps professionnels."
                )}
              </p>
          ...
          <div className="bg-background shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 font-caladea">
                {t(
                  "Détendez-vous avec nos options de massage, disponibles à domicile ou en salon."
                )}
              </p>
              <button className="bg-new text-white mt-4 hover:bg-hover font-bold py-2 px-6 rounded-md transform transition duration-300 hover:scale-105">
                <RouterLink to="/offres">{t("VIEW MORE")}</RouterLink>
          ...
          <div className="bg-background shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-700 font-caladea">
                {t(
                  "Réservez une coupe, une couleur ou un brushing avec nos experts."
                )}
              </p>
              <button className="bg-new text-white mt-4 hover:bg-hover font-bold py-2 px-6 rounded-md transform transition duration-300 hover:scale-105">
                <RouterLink to="/offres">{t("VIEW MORE")}</RouterLink>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div className="offer-card bg-background shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  {t(
                    "Profitez de 20% de réduction sur notre soin du visage signature pour une durée limitée."
                  )}
                </p>
            ...
            <div className="offer-card bg-background shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  {t(
                    "Profitez de 25% de réduction sur toute prestation de coloration et de coiffure."
                  )}
                </p>
                <p className="text-base font-bold text-new">
            ...
            <div className="offer-card bg-background shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300">
              <img
                src={offer3}
                alt="Offre 3"
                className="w-full h-60 object-cover bg-opacity-20"
              />
              <div className="p-6">
                <h3 className="text-2xl font-semibold text-black mb-4">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  {t(
                    "Détendez-vous avec un forfait spa complet à -30% ! Places limitées disponibles."
                  )}
                </p>
                <p className="text-base font-bold text-new">
          ...
          <div className="bg-background shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
            <div className="p-6">
              ...
              <p className="text-gray-700 font-caladea text-start">
                {t(
                  "Gagnez des points à chaque réservation et échangez-les contre des réductions ou des offres spéciales. Plus vous réservez, plus vous économisez !"
                )}
              </p>
            </div>
          </div>
          ...
          <div className="bg-background shadow-lg overflow-hidden transform transition duration-300 hover:scale-105">
            <div className="p-6">
              ...
              <p className="text-gray-700 font-caladea mb-4 text-start">
                {t(
                  "Inscrivez-vous et commencez à accumuler des points dès votre prochaine réservation. Vérifiez vos points dans votre profil."
                )}
              </p>
              <button className="bg-new text-white mt-4 hover:bg-hover font-bold py-2 px-6 rounded-md transform transition duration-300 hover:scale-105">
                <RouterLink to="/signup">
                  {t("Rejoignez Maintenant")}
                </RouterLink>
              </button>
            </div>
          </div>
      ...
      <div id="equipes" className="mx-12 mt-20 text-center">
        <h1 className="text-4xl font-caladea font-thin text-left text-black">
          ÉQUIPES
        </h1>
        <Swiper
          ...
          {teamMembers.map((member, index) => (
            <SwiperSlide key={index} className="slide-item">
              <div className="bg-white p-4 rounded-xl shadow-lg hover:scale-105 transition-all duration-500 min-h-[600px] flex flex-col justify-between">
                ...
                />
                <h3 className="font-caladea text-xl font-semibold">
                  {t(member.name)}
                </h3>
                <h4 className="font-caladea text-lg text-gray-500 italic">
                  {t(member.role)}
                </h4>
      ...
      <div
        id="contact"
        className="mx-12 mt-20 mb-20"
        style={{ textAlign: "center" }}
      >
        {/* Title */}
        <h2 className="text-4xl font-caladea text-start text-balck mb-12">
          CONTACT
        </h2>
