        ...
        <div className="w-full px-6 py-2 bg-new">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              ...
              />
              <span className="ml-0 text-lg font-bold text-white sm:text-xl md:text-2xl">
                Z-Beauty
              </span>
            </div>
            ...
            <ul
              className={`flex items-center text-white font-bold lg:flex ${
                isMenuOpen
                  ? "absolute top-0 right-0 w-1/2 h-screen bg-new text-center flex-col justify-center"
                  : "hidden lg:flex"
              }`}
            >
              <li className="mx-4 py-2">
                <a
                  href="#a-propos"
                  onClick={() => navigateToSection("a-propos")}
              ...
              <li className="mx-4 py-2">
                <a
                  href="#offres"
                  onClick={() => navigateToSection("offres")}
                  className="cursor-pointer hover:text-gray-300"
                >
                  {t("Offres")}
                </a>
              ...
              <li className="mx-4 py-2">
                <a
                  href="#loyalty"
                  onClick={() => navigateToSection("loyalty")}
                  className="cursor-pointer hover:text-gray-300"
                >
                  {t("Loyalty")}
                </a>
              ...
              <li className="mx-4 py-2">
                <a
                  href="#equipes"
                  onClick={() => navigateToSection("equipes")}
                  className="cursor-pointer hover:text-gray-300"
                >
                  {t("Équipes")}
                </a>
            ...
            <div className="flex items-center space-x-4">
              ...
              <RouterLink to="/offres">
                <button
                  className={`bg-white text-black font-bold py-2 px-4 rounded-md shadow-md hover:animate-bounce`}
                >
                  {t("BOOK NOW")}
                </button>
              </RouterLink>
